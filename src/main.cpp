...
uint256 hashGenesisBlock("0x77acfd52155a46b392e968eba1c332e53f51a7472d54791638708742fe1f1028");
...
static const int64 nTargetSpacing = 63;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        const char* pszTimestamp = "GreenCoin - 5/26/2014 Monday, Last Testing";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	CBlock block;
        ...
        block.nVersion = 1;
	block.nTime = 1401144902;
        block.nBits = 0x1e0ffff0;
	block.nNonce = 2042814945;

        if (fTestNet)
        {
			block.nTime =1401116943;
            //block.nTime    = 1398504963;
            block.nNonce   = 2042176024 ;
        }
    ...
    if (block.GetHash() != hashGenesisBlock)
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xaf02bd3f82bac0ff8dfe6510e5d81a2eb362a45da2f78bbca46b249462e7bb6e"));
        block.print();
